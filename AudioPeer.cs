...
public class AudioPeer : MonoBehaviour 
{
   ...
   public _channel channel = new _channel();
    ...
    {
        _audiosource.GetSpectrumData(_samplesLeft, 0, FFTWindow.Blackman);// takes audio sources spectrum data and puts them into samples
        _audiosource.GetSpectrumData(_samplesRight, 1, FFTWindow.Blackman);// takes audio sources spectrum data and puts them into samples
    }
