...
void InitSocket()  //Initialize socket
    {  
        ...
        IPEndPoint sender=new IPEndPoint(IPAddress.Parse("172.20.10.7"),28);  
    ...
    void SocketReceive()  
    {
        ...
        int a = 0;
            while (a<100)
            {
                ...
                print(fsrval);
            StreamWriter sw = new StreamWriter(@"E:\fsr.txt", true);
            StreamWriter sw2 = new StreamWriter(@"E:\fsr2.txt", true);
            string fsr1 = fsrval.ToString();
            string fsr2 = fsrval.ToString();
            sw.WriteLine(fsr1);
            sw2.WriteLine(fsr2);
            sw.Flush();
            sw.Close();
    ...
    public void write()
    {
        StreamWriter sw = new StreamWriter(@"E:\xxx.txt", true);
            string fsr1 = fsrval.ToString();
            sw.WriteLine(fsr1);
            sw.Flush();
            sw.Close();
